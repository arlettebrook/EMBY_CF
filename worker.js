...
<body>
  ...
  <script>
    ...
    function showAddNodeModal() {
      showModal('新增别名组',
        '<div class="form-group"><label>关键字 (keyword)</label><input id="f-keyword" placeholder="例如: mir"></div>' +
...
async function handleAliasProxy(originalRequest, env, ctx, aliasResult) {
    ...
    for (var attempt = 0; attempt < maxRetries; attempt++) {
        ...
        // URL Rewrite: /mir/Users/xxx -> /https://mi2.miraiemby.com/Users/xxx
